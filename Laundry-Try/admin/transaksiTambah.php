    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="col-md-8 col-md-offset-2">
                ...
                <br><br>
                <form action="transaksiAksi.php" method="post">
                    <div class="form-group">
                        <label>Pelanggan</label>
                        <select class="form-control" name="pelanggan" require>
                    ...
                    <div class="form-group">
                        <label>Berat</label>
                        <input type="number" class="form-control" name="berat" placeholder="Masukkan berat cucian .." require>
                    </div>
                    <div class="form-group">
                        <label>Tgl. Selesai</label>
                        <input type="date" class="form-control" name="tgl_selesai" require>
                    </div>
                    <br>
